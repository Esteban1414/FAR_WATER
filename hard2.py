...
from classes_nvl2_hard import Personaje,Items,Background,Animal,Extra,Extra2,Extra3,Boat,WIN_LOSE,Net,Bridge, muestra_texto
...
def nivel_2_hard():
    ...
    items_animations = []
    items_types = ['bota','plastico','lata','llanta']
    ...
    for bri in bridge_types:
        ...
        for animations_10 in animation_types_10:
            ...
            for i in range(num_of_frames_10):
                img_10 = pygame.image.load(f'pruebas_pi/fondo/{bri}/{animations_10}/{i}.png').convert_alpha()
