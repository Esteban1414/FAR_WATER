...
def muestra_texto():
    show_score = letra.render('Score: '+ str(puntaje), 1, BLACK)
...
class Personaje(pygame.sprite.Sprite):
    ...
    def update(self,surface, items_group, animals_group):
        ...
        global coords,flag_2,flag_1,score,puntaje
        move_ticker = 0
...
class Items(pygame.sprite.Sprite):
    def __init__(self, animation_list,x,y,speed):
        pygame.sprite.Sprite.__init__(self)
        self.speed = speed * 2.5#the pixels jump between the other pixels
        self.animation_list = animation_list
        self.frame_index = 0
        self.action = 0
        self.update_time_1 = pygame.time.get_ticks()
    ...
    def update(self,surface):
        ...
        if self.rect.x > right_limit: #or temp_health == 0:
            self.rect.x = -100
            ramdom_y = random.randint(420,580) #update the ramdom place
