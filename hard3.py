...
from classes_nvl3_hard import Personaje,Items,Background,Animal,Extra,Extra2,Extra3,Boat,WIN_LOSE,Net,Bridge, muestra_texto
    ...
    for ship in ship_types:
        ...
        for animations_7 in animation_types_7:
            ...
            for i in range(num_of_frames_7):
                img_7 = pygame.image.load(f'./fondo/{ship}/{animations_7}/{i}.png').convert_alpha()
    ...
    for ship2 in ship2_types:
        ...
        for animations_10 in animation_types_10:
            ...
            for i in range(num_of_frames_10):
                img_10 = pygame.image.load(f'./fondo/{ship2}/{animations_10}/{i}.png').convert_alpha()
