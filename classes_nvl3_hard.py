...
def muestra_texto():
    show_score = letra.render('Score: '+ str(marcador), 1, BLACK)
...
class Personaje(pygame.sprite.Sprite):
    ...
    def update(self,surface, items_group, animals_group):
        ...
        surface.blit(self.image,(self.rect.x-40,self.rect.y-250))

        global coords,flag_2,flag_1,score, marcador
        move_ticker = 0
...
class Items(pygame.sprite.Sprite):
    def __init__(self, animation_list,x,y,speed):
        pygame.sprite.Sprite.__init__(self)
        self.speed = speed * 4 #the pixels jump between the other pixels
        self.animation_list = animation_list
        self.frame_index = 0
        self.action = 0
        self.update_time_1 = pygame.time.get_ticks()
    ...
    def update(self,surface):
        ...
        if self.rect.x > right_limit: #or temp_health == 0:
            self.rect.x = -100
            ramdom_y = random.randint(440,700) #update the ramdom place
...
class Animal(pygame.sprite.Sprite):
    def __init__(self, animation_list,x,y,speed):
        pygame.sprite.Sprite.__init__(self)
        self.speed = speed * 5#the pixels jump between the other pixels
        self.animation_list = animation_list
        self.frame_index = 0
        self.action = 0
        self.update_time_1 = pygame.time.get_ticks()
